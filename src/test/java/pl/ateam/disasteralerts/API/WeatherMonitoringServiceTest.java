...
class WeatherMonitoringServiceTest {
    ...
    @Mock
    private DisasterFacade disasterFacade;
    ...
    void setUp() {
        ...
        weatherMonitoringService = new WeatherMonitoringService(openWeatherClient, disasterFacade);
    }
    ...
    void shouldNotRecordDisastersWhenThresholdsNotExceeded() throws Exception {
        ...
        // Then
        verify(disasterFacade, never()).createDisaster(any(DisasterAddDTO.class), any(String.class));
    }
}
